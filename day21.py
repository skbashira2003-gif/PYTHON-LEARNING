...
# ZeroDivisionError is not handled above.
# Finally executes, then the exception propagates.
# Catch it below to allow the program to continue.

try:
    a = 10 / 0

except Exception as e:
    print("Handled after finally:", e)
...
# ZeroDivisionError below will never be reached for this error.
